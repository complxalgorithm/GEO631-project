...
![Distress presence predictive logit mixed-effects model](imgs/mode_equation.png){fig-alt="Distress presence predictive logit mixed-effects model."}
...
ranef_map <-
  ...
  geom_sf_text(data = st_cities, aes(label = NAME), 
